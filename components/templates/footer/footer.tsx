...
import { faMap,faCircleDown } from '@fortawesome/free-regular-svg-icons'
        ...
        <div className="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
            <div className="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
                <div className="col-lg-3 col-md-6 mb-5">
                    ...
                    <p><i className="fa fa-map-marker-alt mr-2"></i><FontAwesomeIcon onMouseLeave={() => setIsShake(false)} 
                     onMouseEnter={() => setIsShake(true)} icon={faCircleDown} shake={isShake} />123 Street, New York, USA</p>
            ...
            <div className="container-fluid text-center text-white border-top mt-4 py-4 px-sm-3 px-md-5" style={{ borderColor: 'rgba(256, 256, 256, .1)' }}>
                <p className="mb-2 text-white">Copyright &copy; <a className="font-weight-bold" href="#">Domain. All Rights Reserved.</a></p>
